    ...
    <div className={`message ${role === "user" ? "user-message" : "bot-message"}`}>
      {role === "assistant" && (
        <div className="bot-avatar">
          <img src="/ChatGPT.png" className="chatbot-logo" alt="WamedBot" />
        </div>
      )}
...
const PromptSuggestionsRow = ({ onPromptClick }) => {
  const prompts = [
    "ما هي خدمات شركة وميض؟",
    "هل تقدمون خدمات تصميم المواقع؟",
    "ما هي خدمات إنتاج الفيديو؟",
    "كيف يمكنني التواصل معكم؟",
    "هل تقدمون خدمات السيو؟",
    "ما هي خدمات إدارة السوشيال ميديا؟",
  ];
  return (
    ...
    <div className="Chatbot-popup">
      ...
      <div className="chat-body" ref={chatBodyRef}>
        {noMessages ? (
          <>
            <Bubble message={{
              content: "مرحباً! أنا WamedBot، مساعدك الرقمي في شركة وميض للخدمات التسويقية. نحن شركة سعودية مرخصة منذ 2021 متخصصة في التسويق الرقمي والتصميم وإنتاج المحتوى. يمكنك سؤالي عن خدماتنا مثل إدارة السوشيال ميديا، تصميم المواقع، إنتاج الفيديو، السيو، الإعلانات الممولة، وإدارة الأحداث. اختر من الاقتراحات أدناه أو اكتب سؤالك!",
              role: "assistant"
            }} />
